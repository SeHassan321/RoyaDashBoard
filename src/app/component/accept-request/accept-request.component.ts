...
export class AcceptRequestComponent implements OnInit {
  ...
  GetAllProduct() {
    this._ComponentService.GetAllProductWithStatusFalse().subscribe(
      (res) => {
  ...
  acceptProduct(productid:any){
console.log(productid);

    this._ComponentService.updateStutesProduct(productid).subscribe(
      (res)=>{
        this.GetAllProduct();
